...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------- | ------------------------------------------------------------- |
| 🧠 **Bhagavad Gita Bot**           | An AI-powered spiritual assistant that answers Gita-based questions using LLMs                                                                         | Node.js, Express, Gemini     | [GitHub](https://github.com/amish-kumar-07/New_Mini_Project)  |
